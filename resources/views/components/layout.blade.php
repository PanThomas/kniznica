    ...
    <div class="min-h-full">
            ...
            <div x-cloak x-show="show" class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="{{ route('books.index') }}"
                        ...
                        aria-current="page">Knihy</a>
                    <a href="{{ route('readers.index') }}"
                        class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Čitatelia</a>
                </div>
            </div>
        </nav>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $title ?? 'Kniznica' }}</h1>
            </div>
        </header>
        <main>
